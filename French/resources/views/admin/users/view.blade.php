...
@section('title')
    Gérer l'utilisateur : {{ $user->username }}
@endsection
...
<div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="registered" class="control-label">Nom d'utilisateur</label>
                        <div>
                            <input type="text" name="username" value="{{ $user->username }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registered" class="control-label">Prénom du client</label>
                        <div>
                            <input type="text" name="name_first" value="{{ $user->name_first }}" class="form-control form-autocomplete-stop">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="registered" class="control-label">Nom de famille du client</label>
                        <div>
                ...
                <div class="box-footer">
                    {!! csrf_field() !!}
                    {!! method_field('PATCH') !!}
                    <input type="submit" value="Mettre à jour l'utilisateur" class="btn btn-primary btn-sm">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        <label for="password" class="control-label">Mot de passe <span class="field-optional"></span></label>
                        <div>
                            <input type="password" id="password" name="password" class="form-control form-autocomplete-stop">
                            <p class="text-muted small">Laissez vide pour conserver le mot de passe de cet utilisateur. L'utilisateur ne recevra aucune notification en cas de changement de mot de passe.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">Il ne doit y avoir aucun serveur associé à ce compte pour qu'il soit supprimé.</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
                    {!! method_field('DELETE') !!}
                    <input id="delete" type="submit" class="btn btn-sm btn-danger pull-right" {{ $user->servers->count() < 1 ?: 'disabled' }} value="Supprimer l'utilisateur" />
                </form>
            </div>
        </div>
    </div>
