...
@section('content-header')
    <h1>{{ $node->name }}<small>Configurez les paramètres de votre node.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{ route('admin.nodes.view.settings', $node->id) }}">Paramètres</a></li>
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Enregistrer les paramètres</h3>
                </div>
                <div class="box-body row">
                    <!-- Code restant inchangé -->
                </div>
